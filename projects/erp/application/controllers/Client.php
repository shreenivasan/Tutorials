...
{
    private $master_arr=array("index"=>"List Client","edit"=>"Edit Client","add"=>"Add Client","view"=>"View Client","delete"=>"Delete Client","deleteMultiple"=>"Delete Client");
    public $searchArr=array('1'=>'cm.name','2'=>'cm.mobile','3'=>'cm.email_id','4'=>'cm.vat_no');
	...
	$this->data['ascDesc']	= $ascDesc;
        ...
        if ((isset($_POST['txtSearch']) || ($this->input->post('hdnSearch') == '1')) || $search!="") {
            ...
            $searchData=$this->Client_model->fetch_rows($this->current_module,$config["per_page"], $page,$selectCriteria, $sortBy, $sortOrder,$searchval);             
            ...
            $respData = array();
            $respData=$this->Client_model->fetch_rows($this->currentModule,$config["per_page"], $page,$selectCriteria);
...
;
    ...
    {      
        ...
        $this->data["client_details"] = $this->Client_model->get_client_details($id);
        $this->data["client_details"]=  array_shift($this->data["client_details"]);
        $this->load->view($this->view_dir_name.'/EditView.phtml', $this->data);
    }
    ...
    {   
        ...
        if($postData['id']=="")
        {
            ...
            $this->form_validation->set_rules('vat_no', 'required');
            $this->form_validation->set_rules('contact_person_name', 'required');
            ...
            else
            {
                ...
                $data['alternate_mobile'] = $this->input->post('alt_mobile');
                ...
                $data['contact_person_mobile'] = $this->input->post('contact_no');
                ...
                {
                    $query = $this->Client_model->retrieve($this->db->insert_id(),$this->tableid);
        ...
        }else
        {
            ...
            if($this->db->update($this->table_name, $data))
            {
                ...
                $query = $this->Client_model->retrieve($pid);
                $this->data["query"]=array_shift($query->result());
    ...
    {            
        $this->data["client_details"] = $this->Client_model->get_client_details($id,$this->tableid);
        $this->data["client_details"]= array_shift($this->data["client_details"]);
        $this->data['mode']="Details of Client";
