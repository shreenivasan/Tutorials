                ...
                <body>
                    ...
                    <div id="menu">
                        <div class="control-cont">
                            ...
                            <input type="text" class="textbox" id="start" value="19.120224,72.926781" placeholder="e.g:28.612960,77.229455" autocomplete="off" /><br/>
                            ...
                            <input type="text" class="textbox"  id="via" value="" placeholder="e.g:28.570841,77.325929" autocomplete="off" /><br>
                                ...
                                <div>
                                    <input type="text" class="textbox"  id="destination" value="19.129420,72.933570" placeholder="e.g:27.157015,77.991600" autocomplete="off" />
                                </div>
                                ...
                                <div style="margin:20px 0 5px 0px;">
                                    ...
                                    <script>
                                        ...
                                        //var centre = new L.LatLng(19.120224,72.926781);

                                        /*put your REST API URL with key here**/
                                        var route_api_url = 'http://apis.mapmyindia.com/advancedmaps/v1/hky1k6t2g4q49881ej8ujav5flf7hywx/route?';
